...
import xio.sds.client.model.SettingResp;
...
public class SettingsApi {
     ...
     */
    public SettingResp getSettings() throws ApiException {
        ApiResponse<SettingResp> resp = getSettingsWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * list settings
     * @return ApiResponse&lt;SettingResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SettingResp> getSettingsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getSettingsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<SettingResp>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getSettingsAsync(final ApiCallback<SettingResp> callback) throws ApiException {
