...
public class VersionApi {
     ...
     */
    public VersionResp getVersion() throws ApiException {
        ApiResponse<VersionResp> resp = getVersionWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * show version
     * @return ApiResponse&lt;VersionResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VersionResp> getVersionWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getVersionValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<VersionResp>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getVersionAsync(final ApiCallback<VersionResp> callback) throws ApiException {
